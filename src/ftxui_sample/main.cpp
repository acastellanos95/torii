...
// configuration step. It creates a namespace called `torii`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", torii::cmake::project_name, torii::cmake::project_version) };
